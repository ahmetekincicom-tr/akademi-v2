...
import { getYaziBySlug, getYayindakiYazilar, ilgiliYazilar } from "@/lib/yazilar";
...
/*
  Yayındaki yazılar derleme anında SSG'leniyor; sonradan panelden yayınlanan
  yeni bir yazı dynamicParams ile ilk istekte üretiliyor (yeniden derleme
  beklemeden 200 dönüyor), sonra ISR ile önbelleğe alınıyor.
*/
