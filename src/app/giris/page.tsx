    ...
    <AuthShell topText="Hesabın yok mu?" topLinkLabel="Hesap oluştur" topLinkHref="/kayit">
      <div>
        ...
        <div className="mt-6 flex items-center gap-[14px]">
          ...
          <span className="font-mono text-[10px] tracking-[0.14em] text-[#9CA1AE] uppercase">veya</span>
          <span className="h-px flex-1 bg-ink/10" />
        </div>

        <button
          type="button"
          className="mt-5 flex h-[50px] w-full items-center justify-center gap-[10px] rounded-[11px] border border-ink/14 bg-white text-[15px] font-semibold text-ink hover:border-brand hover:text-brand"
        >
