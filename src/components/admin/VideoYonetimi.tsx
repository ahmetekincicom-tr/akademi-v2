  ...
  return (
    <main className="p-7 pb-14">
      ...
      <div className="mt-[18px] overflow-hidden rounded-2xl border border-ink/10 bg-white">
        <div className="grid grid-cols-[2fr_1.5fr_1fr_0.8fr_110px] gap-4 border-b border-ink/8 bg-mist px-[22px] py-[13px] font-mono text-[9.5px] tracking-[0.12em] text-[#8A8F9E] uppercase">
          <span>Ders</span>
          <span>Eğitim</span>
          <span>Modül</span>
          <span>Durum</span>
        ...
        {listelenen.length === 0 ? (
          ...
          listelenen.map((d) => (
            <div key={d.id} className="border-b border-ink/7 last:border-b-0">
              <div className="grid grid-cols-[2fr_1.5fr_1fr_0.8fr_110px] items-center gap-4 px-[22px] py-[14px] hover:bg-[#F7F9FF]">
